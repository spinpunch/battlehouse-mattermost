...
func AuthenticateUserForLogin(id, loginId, password, mfaToken, rawBcrypt, BHApiSecret, deviceId string, ldapOnly bool) (*model.User, *model.AppError) {
...
func DoLogin(cookieDomain string, w http.ResponseWriter, r *http.Request, user *model.User, deviceId string) (*model.Session, *model.AppError) {
